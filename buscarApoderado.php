...
$consulta = "SELECT * FROM persona WHERE concat(Nombre,' ',Ap_Paterno,' ',Ap_Materno) like '%".$q."%' and numero=2 ORDER BY nombre LIMIT 10";
...
?>
<a href="mantenedor_apo.php?id=<?php echo @$id_apo; ?>" style="text-decoration:none;" >
...
<div style="margin-right:6px; font-size:12px;" class="div_detalle"><?php echo "Apoderado de: <strong>".$aea; ?></strong></div></div>
</a>
